...
(function() {
    ...
    const defaultBanks = {
        names: { label: '姓名', icon: '👤', words: ['艾伦','莉娜','凯恩','索菲亚','雷克斯','艾薇','奥斯卡','梅林','伊莎贝拉','亚瑟','露娜','卡尔','菲奥娜','加雷斯','塞琳娜'] },
        places: { label: '地名', icon: '🏔️', words: ['幽暗森林','龙脊山脉','银月城','风暴海岸','暗影谷','光明圣殿','冰霜平原','赤焰沙漠','翡翠湖','雷鸣峡谷','星辰塔','月影沼泽'] },
        events: { label: '事件', icon: '⚡', words: ['神秘的旅人到来','古老的预言应验','失落的宝藏被发现','王位争夺战开始','黑暗势力觉醒','英雄陨落','新联盟成立','禁忌魔法被破解','巨龙苏醒','时空裂缝出现'] },
        items: { label: '物品', icon: '🎁', words: ['破晓之剑','永恒之盾','智慧之冠','隐身斗篷','传送戒指','生命药水','龙鳞甲','魔法书','时光沙漏','灵魂宝石','风暴之弓','月光匕首'] }
    };
    ...
    function getBank(type) {
        ...
        return defaultBanks[type] || { label: type, icon: '🎲', words: [] };
    }
    ...
    ModuleRegistry.register({
        id: 'generators', name: '随机生成器', icon: '🎲', group: 'writing', order: 4,
