...
const ModuleRegistry = (function() {
    ...
    const groups = {
        ...
        'world':     { name: '世界设定', icon: 'earth', order: 1 },
        'character': { name: '角色成长', icon: 'user', order: 2 },
        'story':     { name: '故事线', icon: 'book', order: 3 },
        'writing':   { name: '写作辅助', icon: 'edit', order: 4 },
        'system':    { name: '系统', icon: 'settings', order: 5 }
    };
